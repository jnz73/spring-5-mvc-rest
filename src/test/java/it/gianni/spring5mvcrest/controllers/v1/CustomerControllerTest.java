...
public class CustomerControllerTest extends AbstractRestControllerTest {
    ...
    public void getCustomerById() throws Exception {
        ...
        mockMvc.perform(get(CustomerController.BASE_URL + "/1").accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andExpect(jsonPath("$.firstname", equalTo("John")));
    ...
    public void testDeleteCustomer() throws Exception {
        ...
        mockMvc.perform(delete(CustomerController.BASE_URL + "/1").accept(MediaType.APPLICATION_JSON).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
